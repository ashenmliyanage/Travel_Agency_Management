...
public class VehicallMail {
    ...
    public static void setEmailCom(String email,String name) throws Exception {
        new Gmailer().sendMail("Your, Agent", "<!DOCTYPE html>\n" +
                "<html>\n" +
                "<head>\n" +
                "    <style>\n" +
                "        body {\n" +
                ...
                "    <div class=\"container\">\n" +
                "        <h1>Hello "+name+"\uD83D\uDC4B</h1>\n" +
                "        <h2><strong>The Vehicle you booked is Already booked</strong></h2>\n" +
                "        <h2>Please Book a another vehicle</strong></h2>\n" +
                "    </div>\n" +
                "</body>\n" +
                "</html>\n",email);
    }
